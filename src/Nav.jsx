...
export default function Nav() {
  return (
    <div className="m-0 p-0 w-screen h-full ">
      <img src={Logo} alt="" />
      <div className="flex justify-between bg-blue-900">
        ...
        <div className="">
          <div className="font-bold text-lg">
            <ion-icon name="call-outline"></ion-icon> 9860732541
          </div>
          <div className="font-bold text-lg">
            <ion-icon name="call-outline"></ion-icon> 9808589912
          </div>
        </div>
      ...
      <div>
        <ul className="md:flex justify-around bg-blue-800 ">
          <li className="home cursor-pointer font-bold mb-2 md:mt-0">Home</li>
          <li className="service cursor-pointer font-bold my-2 md:mt-0">
            Service Areas
          </li>
          <li className="Blog cursor-pointer font-bold my-2 md:mt-0">Blog</li>
          <li className="contact cursor-pointer font-bold my-2 md:mt-0">
            Contact us
          </li>
          <li className="about cursor-pointer font-bold my-2 pb-3 md:mr-5 md:pr-5 md:m-0">
            About
          </li>
        </ul>
      </div>
